...
export const ROLES = [
  {
    ...
    title: (
      <>
        <PrimaryTitle>Practice with purpose. </PrimaryTitle>
        <AccentTitle>Interview with confidence.</AccentTitle>
      </>
    ),
    desc:
  ...
  },
  {
    ...
    title: (
      <>
        <PrimaryTitle>Help candidates </PrimaryTitle>
        <AccentTitle>perform at their best.</AccentTitle>
      </>
    ),
    desc:
